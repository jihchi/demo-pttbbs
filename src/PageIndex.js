...
import * as TrendingPosts from "./components/TrendingPosts.js";
...
function getServerSideProps(_ctx) {
  return $$Promise.$$catch(Api.getHotPosts(100, /* Desc */1, undefined).then(function (res) {
                      return res.json();
                    }).then(function (json) {
              ...
              return Promise.resolve({
                          props: {
                            hotPosts: Belt_Result.getWithDefault(result, [])
                          }
                        });
            });
}
